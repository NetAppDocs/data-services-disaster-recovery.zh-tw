...
* 請確保您使用的是支援的 Kubernetes 版本。災難恢復支援 link:https://docs.netapp.com/us-en/trident/trident-protect/trident-protect-requirements.html["Trident Protect 目前支援的任何 Kubernetes 版本"^]。
* 設定適當的 link:../reference/trident-permissions.html["Trident Protect 的權限"]。
...
安裝 link:https://docs.netapp.com/us-en/trident/trident-use/vol-group-snapshots.html#deploy-a-volume-snapshot-controller["快照 CRD 和快照控制器"^]。這些安裝是 Trident Protect 中 Volume 快照的必要條件。
...
完成 Trident Protect 和 Kubernetes 設定後，link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-disaster-rec-roles.html["確保您擁有正確的災難恢復 Console 角色，以便執行探索、容錯移轉和其他任務。"^]
