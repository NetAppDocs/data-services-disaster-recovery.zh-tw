...
summary: 首先，使用NetApp Disaster Recovery提供複製計畫名稱並選擇複製的來源和目標 vCenter。 
---
= 建立複製計畫：步驟 1 - 在NetApp Disaster Recovery中選擇 vCenter
:allow-uri-read: 


[role="lead"]
首先，使用NetApp Disaster Recovery，提供複製計劃名稱並選擇複製的來源和目標 vCenter。
