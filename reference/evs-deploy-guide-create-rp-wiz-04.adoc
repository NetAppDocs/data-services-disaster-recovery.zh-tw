...
summary: 使用 Amazon EVS 和Amazon FSx for NetApp ONTAP介紹NetApp災難復原。在NetApp Disaster Recovery 中新增所有複製計畫資訊後，請驗證您輸入的資訊是否正確。 
---
= 建立複製計畫：步驟 4 - 驗證NetApp災難復原中的設置
:allow-uri-read: 


[role="lead"]
在NetApp Disaster Recovery 中新增複製計畫資訊後，請驗證您輸入的資訊是否正確。
